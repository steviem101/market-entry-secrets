...
const DATA: LeadLike[] = [
  { title: "AU Fintech Founders", description: "", short_description: "", tags: ["fintech"], list_type: "Lead Database", location: "Sydney", sector: "Fintech", record_count: 500, created_at: "2026-01-01" },
  { title: "ANZ Market Data", description: "", short_description: "market sizing", tags: [], list_type: "Market Data", location: "Melbourne", sector: "SaaS", record_count: 50, created_at: "2026-03-01" },
  { title: "TAM Map Health", description: "", short_description: "", tags: ["health"], list_type: "TAM Map", location: "Sydney", sector: "Health", record_count: 1000, created_at: "2026-02-01" },
];
...
test("location + sector filters", () => {
  assert.deepEqual(filterAndSortLeads(DATA, { ...base, location: "Sydney" }).map((l) => l.title), ["TAM Map Health", "AU Fintech Founders"]);
  assert.deepEqual(filterAndSortLeads(DATA, { ...base, sector: "SaaS" }).map((l) => l.title), ["ANZ Market Data"]);
});
test("search matches title, short_description, and tags", () => {
