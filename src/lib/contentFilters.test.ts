...
const DATA: ContentItemLike[] = [
  { title: "Entry Guide", subtitle: "how to enter", content_type: "guide", category_id: "cat-legal" },
  { title: "Market Article", subtitle: "trends", content_type: "article", category_id: "cat-market" },
  { title: "Win Story", subtitle: "success", content_type: "success_story", category_id: "cat-legal" },
];
const base = { search: "", type: "all", category: "all" };
