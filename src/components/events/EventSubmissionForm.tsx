...
export const EventSubmissionForm: React.FC<EventSubmissionFormProps> = ({ onEventSubmitted }) => {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Organization or person name" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Conference, Workshop, Forum" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
