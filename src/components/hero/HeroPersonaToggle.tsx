...
export const HeroPersonaToggle = ({
  ...
  return (
    <div className="relative inline-flex bg-muted rounded-xl p-1 border border-border">
      {/* Sliding background indicator */}
      <div
        className={`absolute top-1 bottom-1 w-[calc(50%-2px)] bg-background shadow-sm rounded-lg transition-transform duration-300 ease-out ${
