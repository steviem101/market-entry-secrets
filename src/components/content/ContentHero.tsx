    ...
    <section className="bg-gradient-to-r from-teal-500/10 to-cyan-500/10 py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
          Compliance guides, market research, templates and checklists to help international companies enter the Australian market
        </p>
        ...
        {/* Only show stats when counts are meaningful */}
        {(totalContent >= 5 || totalCategories >= 5) && (
