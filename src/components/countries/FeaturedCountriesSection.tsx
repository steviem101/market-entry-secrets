...
const FeaturedCountriesSection = () => {
  ...
  return (
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4">Featured Countries</h2>
        <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
          Explore market entry opportunities from countries with strong trade relationships and established support networks in Australia.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
