    ...
    tiers: [
      {
        ...
        features: [
          'Full AI market-entry report — executive summary, SWOT, competitor & investor landscape, and action plan',
      ...
      },
      {
        ...
        features: [
          ...
          'AI-matched mentor & advisor recommendations unlocked in your report',
          '20–30 minute walkthrough call with your advisor',
          '1 personal mentor introduction + 3 ecosystem introductions',
      ...
      },
      {
        ...
        features: [
          ...
          '60-minute strategy session with your advisor',
          '2 mentor introductions + priority ecosystem access',
          'Curated lead list matched to your report — delivered to your member hub within 48 hours, tuned after your session',
          'Your First Customers — end-buyer & go-to-market playbook',
    ...
    tiers: [
      {
        ...
        features: [
          'Full AI growth report — executive summary, SWOT, competitor & investor landscape, and action plan',
      ...
      },
      {
        ...
        features: [
          'Everything in Free, plus:',
          'AI-matched advisor & mentor recommendations unlocked in your report',
          '20–30 minute walkthrough call with your advisor',
          '1 personal mentor introduction + 3 ecosystem introductions',
