...
test("goalsToPrioritisedSections maps selected goals to the report sections they feed", () => {
  ...
  const valid = new Set(["executive_summary", "swot_analysis", "competitor_landscape", "service_providers", "mentor_recommendations", "events_resources", "case_studies_guides", "action_plan", "setup_compliance", "lead_list", "investor_recommendations"]);
