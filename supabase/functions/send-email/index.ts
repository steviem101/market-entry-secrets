...
serve(async (req: Request) => {
  ...
  // Render the email from the in-repo shared template module.
  ...
  try {
    ...
    // 3. Send the rendered HTML via Resend
    const result = await sendViaResend(recipient_email, rendered.subject, rendered.html);
