-- ============================================================================
-- CASE STUDIES MIGRATION PART 2: OpenAI, Anthropic, AWS, Salesforce, Amazon.com
-- ============================================================================
...
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'openai-australia-market-entry'),
  'OpenAI', 'AI', 'United States', 'Australia', '2025', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'openai-australia-market-entry'),
  'Sam Altman', 'CEO, OpenAI', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'anthropic-australia-market-entry'),
  'Anthropic', 'AI', 'United States', 'Australia', '2026', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'anthropic-australia-market-entry'),
  'Dario Amodei', 'CEO & Co-founder, Anthropic', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'aws-australia-market-entry'),
  'Amazon Web Services (AWS)', 'Cloud Computing', 'United States', 'Australia', '2012', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'aws-australia-market-entry'),
  'Matt Garman', 'CEO, Amazon Web Services', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'salesforce-australia-market-entry'),
  'Salesforce', 'Cloud CRM and AI', 'United States', 'Australia', '2004', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'salesforce-australia-market-entry'),
  'Marc Benioff', 'Chair & CEO, Salesforce', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'amazon-australia-ecommerce-entry'),
  'Amazon.com', 'E-commerce and Retail Technology', 'United States', 'Australia', '2017', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'amazon-australia-ecommerce-entry'),
  'Andy Jassy', 'CEO, Amazon', true
);
