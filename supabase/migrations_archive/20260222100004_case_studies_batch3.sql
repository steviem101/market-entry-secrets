-- ============================================================================
-- CASE STUDIES MIGRATION PART 4: Databricks, Snowflake, ServiceNow, Palantir, Xero, UiPath
-- ============================================================================
...
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'databricks-australia-market-entry'),
  'Databricks', 'Data and AI Analytics', 'United States', 'Australia', '2017', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'databricks-australia-market-entry'),
  'Ali Ghodsi', 'CEO & Co-founder, Databricks', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'snowflake-australia-market-entry'),
  'Snowflake', 'Cloud Data Warehousing', 'United States', 'Australia', '2017', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'snowflake-australia-market-entry'),
  'Sridhar Ramaswamy', 'CEO, Snowflake', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'servicenow-australia-market-entry'),
  'ServiceNow', 'Cloud IT Service Management', 'United States', 'Australia', '2022', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'servicenow-australia-market-entry'),
  'Bill McDermott', 'Chair & CEO, ServiceNow', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'palantir-australia-market-entry'),
  'Palantir Technologies', 'Data Analytics and AI', 'United States', 'Australia', '2013', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'palantir-australia-market-entry'),
  'Alex Karp', 'CEO & Co-founder, Palantir', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'xero-australia-market-entry'),
  'Xero', 'Cloud Accounting Software', 'New Zealand', 'Australia', '2009', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'xero-australia-market-entry'),
  'Sukhinder Singh Cassidy', 'CEO, Xero', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'uipath-australia-market-entry'),
  'UiPath', 'Robotic Process Automation (RPA) and AI', 'United States', 'Australia', '2018', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'uipath-australia-market-entry'),
  'Daniel Dines', 'CEO & Co-founder, UiPath', true
);
