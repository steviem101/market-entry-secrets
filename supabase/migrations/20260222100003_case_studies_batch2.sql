-- ============================================================================
-- CASE STUDIES MIGRATION PART 3: GitHub, Zoom, Tesla, Twilio, DocuSign
-- ============================================================================
...
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'github-australia-market-entry'),
  'GitHub', 'Technology / Software Development Platform', 'United States', 'Australia', '2025', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'github-australia-market-entry'),
  'Thomas Dohmke', 'CEO, GitHub', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'zoom-australia-market-entry'),
  'Zoom Video Communications', 'Technology / Video Communications', 'United States', 'Australia', '2019', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'zoom-australia-market-entry'),
  'Eric Yuan', 'CEO & Founder, Zoom', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'tesla-australia-market-entry'),
  'Tesla', 'Electric Vehicles / Clean Technology', 'United States', 'Australia', '2014', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'tesla-australia-market-entry'),
  'Elon Musk', 'CEO, Tesla', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'twilio-australia-market-entry'),
  'Twilio', 'Cloud Communications Technology', 'United States', 'Australia', '2018', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'twilio-australia-market-entry'),
  'Jeff Lawson', 'Co-founder, Twilio', true
);
...
INSERT INTO public.content_company_profiles (content_id, company_name, industry, origin_country, target_market, entry_date, outcome)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'docusign-australia-market-entry'),
  'DocuSign', 'Digital Signature Technology', 'United States', 'Australia', '2018', 'successful'
);

INSERT INTO public.content_founders (content_id, name, title, is_primary)
VALUES (
  (SELECT id FROM public.content_items WHERE slug = 'docusign-australia-market-entry'),
  'Allan Thygesen', 'CEO, DocuSign', true
);
