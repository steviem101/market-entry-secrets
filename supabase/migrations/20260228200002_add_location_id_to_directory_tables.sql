-- Migration: Ensure locations table exists, then add location_id FK to directory tables
-- Merged from the former 20260228200001_locations migration to avoid version conflicts

-- ============================================================
-- Part 0: Ensure locations table exists (for fresh preview envs)
-- ============================================================
...
-- ============================================================
-- Part 1: Add nullable location_id FK to directory tables
-- ============================================================
