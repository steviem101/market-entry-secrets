# Australian Market Entry Failures — Council Additions

*Supplementary research-validated case studies for MES, May 2026.*

These 7 cases were proposed by a multi-model council review of the original
20-case library and added after independent primary-source verification.
The cases cluster into two families:

- **Australian regulatory/legal failure modes** (Foodora, Viagogo, Pizza Hut, Valve, Binance) — companies that were brought to ground (or fundamentally constrained) by Australia's regulatory and consumer-protection environment.
- **Cancelled / aborted entries** (Kaufland, MilkRun) — entries that never reached operating maturity, where the failure mode was visible during execution rather than after collapse.
...
Viagogo is a Switzerland-headquartered global ticket-resale marketplace that has operated in Australia for years through its `viagogo.com` site, marketed heavily via search-engine ads. The ACCC sued Viagogo in 2017 for misleading ticket pricing and false "official seller" claims. After an "industrial scale" finding by the Federal Court and an unsuccessful appeal, Viagogo was ordered in October 2020 to pay a A$7 million penalty — making it one of the cleanest examples of Australian Consumer Law (ACL) enforcement against an offshore digital business.

**Australia Entry Strategy**

Viagogo entered Australia as a fully online operation, with no Australian office — relying on search-engine bidding (heavily on event names like "Ashes cricket tickets" and "Book of Mormon tickets") to capture intent traffic, then routing buyers through a checkout that disclosed booking and handling fees only at the final step. The "lean digital entry" model was the same one Viagogo used in the UK, US and Europe.

**What Went Wrong in Australia**

- **"Official seller" representations:** Viagogo's site implied it was an authorised reseller for events when it was a secondary marketplace. Australian consumers booking through Viagogo regularly discovered they had paid above-face-value prices for tickets they could have bought directly.
- **Drip-pricing through hidden booking fees:** During the 1 May 2017 to 26 June 2017 sample period the ACCC examined, Viagogo advertised headline prices that excluded a 27.6% booking fee disclosed only at checkout. Examples cited at trial included a Book of Mormon ticket advertised at A$135 but charged at A$177.45, and an Ashes cricket ticket advertised at A$330.15 sold for A$426.81.
- **Scarcity messaging:** Statements that "only X tickets left" combined with countdown timers were found by Justice Burley to make false or misleading representations of scarcity that Viagogo could not substantiate.
- **"Industrial scale":** The Federal Court explicitly described one category of representation as having been made "on an industrial scale" — language that drove the size of the eventual penalty.
- **The "we operate from overseas" defence failed:** Viagogo argued that its Swiss base limited its ACL exposure. The Federal Court and Full Federal Court both rejected this, confirming that operating from overseas does not defeat Australian Consumer Law jurisdiction over conduct directed at Australian consumers.

**Outcome in Australia**

In April 2019, the Federal Court found Viagogo had misled consumers. In October 2020, the Court imposed a A$7 million penalty. Viagogo appealed; the Full Federal Court dismissed the appeal in 2021, upholding both the liability findings and the A$7M penalty. The Court additionally ordered Viagogo to display ACL-compliant pricing and to implement a consumer-compliance programme. Viagogo continues to operate in Australia, but has restructured its checkout to display total prices upfront — a behavioural change driven entirely by the enforcement outcome.

**Lessons for MES**
- **Operating from overseas does not defeat ACL jurisdiction.** If your site sells to Australians, you are an Australian Consumer Law duty-bearer. The Viagogo case is now the leading authority on this point.
- **Drip pricing is enforceable misconduct in Australia.** Booking fees, handling fees, and platform fees that are revealed late in checkout are routinely treated by the ACCC as misleading conduct under s18 ACL.
- **Scarcity messaging must be substantiated.** "Only 2 tickets left" claims that are not literally true are misleading; the ACCC actively monitors these.
- **"Industrial scale" language is a sentencing multiplier.** When a Federal Court judge writes that conduct was at "industrial scale", the penalty will be calibrated to deter the global operator, not just the local subsidiary.
- **Compliance programmes are an ongoing remedy, not a one-off cost.** Viagogo's ACCC outcome included multi-year compliance and disclosure obligations on top of the cash penalty.
...
Kaufland is the supermarket arm of Germany's Schwarz Group (which also owns Lidl). After more than two years of Australian build-up — A$523 million in committed paid capital, a 100,000 sqm Melbourne distribution centre under construction, approvals for 20 stores across Victoria, Queensland, South Australia and NSW, and 200 Australian staff hired — Kaufland announced in January 2020 that it was abandoning the Australian market without opening a single store. It is the largest cancelled greenfield retail entry in Australian history.

**Australia Entry Strategy**

Kaufland's entry plan was the model "Lidl-style" big-box discount supermarket rollout that had worked in Germany, Poland, the Czech Republic and Romania: 20 large-format stores supported by a single high-volume distribution centre, anchored by a deep private-label range. The first store was scheduled to open in 2020, with an aggressive multi-year ramp to follow.

**What Went Wrong in Australia**

- **Coles and Woolworths' supplier discipline:** Suppliers reported being discouraged from supporting a third major banner; Coles/Woolworths control approximately 65% of Australian grocery and have historically prevented entrants from securing range parity. This is the same pattern that killed Masters Home Improvement against Bunnings (Case 2 in the original library).
- **Site assembly problems:** Kaufland required sites of 6,000–10,000 sqm with very specific access requirements. Securing 20 such sites simultaneously triggered planning resistance from local councils, opposition campaigns, and bidding wars. Reports surfaced of ratepayer pushback, traffic-impact litigation, and slowed approvals.
- **Talent and supply chain capacity constraints:** The 2019 drought and 2019–20 bushfires materially compressed Australian grocery supply chains and made retail management talent scarcer at exactly the wrong time. Kaufland would have been hiring its first cohort of store managers into a market with collapsing fresh-produce reliability.
- **Schwarz Group strategic refocus:** Internal Schwarz reporting concluded that the capital required to reach Australian profitability was disproportionately large relative to investing the same money in growing Lidl in continental Europe. The decision was framed publicly as a "concentrated focus on European core markets".
- **No public launch ever occurred:** Unlike Masters or Esprit, there was no public store, no transactions, and no consumer brand to defend — making the decision to abandon dramatically cheaper than the alternative of a partial launch followed by retreat.

**Outcome in Australia**

On 22 January 2020, Schwarz Group announced "an orderly withdrawal from the Australian market". Approximately 200 Australian staff were affected; the Melbourne distribution centre and 20 store sites went on the secondary market. The ACCC subsequently noted that Kaufland's withdrawal had a measurable adverse impact on supermarket competition, citing it in submissions about the structural difficulty of new entry against the major chains. Schwarz Group reportedly absorbed approximately A$523 million in pre-launch costs.

**Lessons for MES**
- **Cancelled entries can be more instructive than collapsed ones.** Kaufland is a forensic case study in pre-launch failure — every constraint that caused the decision was visible inside the Australian market before any consumer saw a Kaufland store.
- **Supplier access is a structural pre-condition, not a procurement task.** Australia's grocery duopoly creates a supplier loyalty effect that no amount of capital can outbid in the short term.
- **Site assembly is a multi-year project that must run in parallel with regulatory and community engagement.** Twenty large-format sites simultaneously is operationally aggressive even for a well-funded entrant.
- **A$523M in sunk cost is an expensive lesson, but cheaper than launching and retreating.** A public launch with 20 stores would have multiplied the loss by 3–5x.
- **The ACCC's competition concerns about supermarket concentration are now part of the public record.** Future entrants can use Kaufland's exit and ACCC supermarket inquiry findings as a strategic risk-mapping tool.
...
### Case 24 — Pizza Hut Australia franchisee class action

**Overview**

Pizza Hut Australia is operated under franchise from Yum! Restaurants Australia Pty Ltd, the local subsidiary of US-based Yum! Brands. In 2014 Yum responded to Domino's Australian price aggression by mandating a A$4.95 price floor for one tier of pizzas and A$8.50 for another — prices that 190 Pizza Hut franchisees said were below their own cost of production. The franchisees brought a class action in 2014 alleging unconscionable conduct and breach of duties. The Federal Court dismissed the claim in 2016 and the Full Federal Court dismissed the franchisee appeal — but 32 franchisee businesses had already collapsed, and the case is now the leading Australian authority on whether a master franchisor can lawfully dictate pricing that destroys franchisee profitability.

**Australia Entry Strategy**

Pizza Hut entered Australia decades ago and operates almost entirely through Australian-based franchisees buying area licences from Yum! Restaurants Australia. The "Value Strategy" was a unilateral pricing policy imposed by the franchisor in 2014 — not a market entry move per se, but a policy decision that operated as a forced re-entry into the value tier of the Australian QSR market against Domino's.

**What Went Wrong in Australia**

- **"Value Strategy" mandated below-cost pricing:** Yum! Restaurants Australia reduced pizza prices from A$9.95 to A$4.95 for one tier and from A$11.95 to A$8.50 for another, simultaneously cutting the range from four pizza tiers to two. Franchisees argued (and presented evidence) that A$4.95 was below their fully loaded cost of production, particularly in regional locations.
- **Domino's was the structural cause:** Domino's Australian arm had launched aggressive value pricing first, and Yum's response was reactive. The franchisee economics that had sustained Pizza Hut at A$9.95 simply could not sustain A$4.95.
- **Franchisor power to set price was absolute under the franchise agreement:** The class action alleged Yum had implied duties of good faith and an obligation to set profitable prices. The Federal Court (Diab v Yum! Restaurants Australia) rejected both arguments — the franchise agreement gave Yum the express right to set prices, and the implied duty did not override that express term.
- **32 franchisee insolvencies:** During the period of the Value Strategy, 32 Pizza Hut franchisees lost their businesses. The class action funder was, in some cases, the liquidator of those franchise companies — a sign of how deep the franchisee distress went.
- **The franchisor was profitable while the franchisees collapsed:** Because Yum collected fees on gross store revenue regardless of franchisee profitability, the value strategy was rational for Yum and lethal for franchisees — the textbook misalignment that the class action sought (and failed) to redress.

**Outcome in Australia**

Justice Wigney dismissed the franchisee class action in February 2016. The franchisees appealed; the Full Federal Court dismissed the appeal in 2017. The case is now widely cited in Australian franchising literature as the leading authority that a franchisor can require franchisees to sell at unprofitable prices, provided the franchise agreement contains an express price-setting clause and the franchisor does not act dishonestly or in bad faith. The case directly informed the 2019 Australian Government Inquiry into Franchising and the resulting reforms to the Franchising Code.

**Lessons for MES**
- **Master-franchise pricing power can override unit economics.** If your Australian entry strategy depends on franchising, the franchise agreement's pricing-control clause is the single most important paragraph — read it as if you were the franchisee.
- **Domino's-style value-tier pricing is contagious.** A QSR entrant launching at premium prices in Australia must model the scenario where a competitor forces a A$4.95 floor and you have to follow.
- **Implied duties of good faith do not protect franchisees from express terms.** Australian courts will not rewrite a clear franchise agreement on equitable grounds; the protection has to be drafted into the contract.
- **The 2019 Franchising Code reforms are a regulatory tailwind for franchisor scrutiny.** Future cases of this type will be litigated against a more prescriptive disclosure regime, but the underlying contract law remains.
...
Valve Corporation is the US-based operator of the Steam digital game distribution platform. In a March 2016 judgment that became the leading Australian authority on consumer guarantees for digital goods, the Federal Court found Valve had breached the Australian Consumer Law by representing in its Steam subscriber agreements and refund policies that consumers had no right to a refund. The Court ordered Valve to pay A$3 million in penalties in December 2016. Valve appealed, lost in the Full Federal Court (December 2017), and was denied special leave to appeal by the High Court (April 2018).

**Australia Entry Strategy**

Valve operated Steam as a pure cross-border digital platform — no Australian office, no Australian subsidiary, no local servers — relying on its US terms of service to govern transactions with Australian users. This "lean entry" model was the same one used by Viagogo (Case 22) and a common pattern for software-as-a-service and digital-marketplace operators entering smaller markets opportunistically.

**What Went Wrong in Australia**

- **Refund clauses contradicted s54 of the ACL:** The Steam subscriber agreement stated that Valve was not under any obligation to provide refunds for video games, and Steam's published refund policy reinforced this. Section 54 of the Australian Consumer Law guarantees that goods (which the Court held includes digital goods) be of acceptable quality, and that breach of guarantee gives consumers an entitlement to refund — non-waiveable, regardless of what the contract says.
- **"Goods" includes digital downloads:** Justice Edelman explicitly held that video games delivered via Steam were "goods" within the meaning of s54, despite Valve's argument that digital downloads were a service. This finding remains foundational to all subsequent ACL enforcement against digital platforms.
- **"We are not subject to Australian law" was a culture problem, not just a legal position:** Justice Edelman wrote that "Valve's culture of compliance was, and is, very poor", noting that internal Valve evidence showed the company "formed a view that it was not subject to Australian law" — a finding that drove the size of the penalty.
- **The conduct affected over 2 million Australian Steam users** during the relevant period. The breadth of the affected user base contributed to the A$3 million penalty (then the largest ACL penalty against a digital platform).
- **Three appeals failed:** Valve lost the original 2016 case, the 2017 Full Federal Court appeal, and the 2018 High Court special leave application — across three Federal Court judges, three Full Federal Court judges, and the High Court bench.

**Outcome in Australia**

Valve paid the A$3 million penalty in 2018. The Court additionally ordered: a 3-year restraint on representing that Valve was not subject to ACL or could decline refunds, a 12-month obligation to publish ACL-rights notices on its website, and an obligation to implement a multi-year consumer-compliance programme for staff. Steam continues to operate in Australia today and now offers ACL-compliant refunds, but the Valve case is now the most-cited Australian authority for the proposition that foreign digital platforms cannot contract out of Australian Consumer Law.

**Lessons for MES**
- **The ACL applies to digital goods, not just physical goods.** Software, games, courses, NFTs, and SaaS subscriptions are all "goods" or "services" within the meaning of the ACL.
- **You cannot contract out of consumer guarantees.** A clause in your terms saying "no refunds" is not just unenforceable in Australia — it is itself a misleading representation that triggers s18 ACL liability.
- **Cross-border digital platforms are within ACL jurisdiction.** Operating from the US (Valve) or Switzerland (Viagogo) does not exclude you from Australian consumer law.
- **Compliance culture is admissible evidence.** Justice Edelman's finding that Valve's compliance culture was "very poor" was based on internal Valve emails — meaning your engineering, support, and policy team's internal communications can be discoverable in ACL litigation.
...
### Case 26 — Binance Australia Derivatives
...
*Council additions appended to the original 20-case library, May 2026. All sources verified against primary regulators (FWO, ACCC, ASIC), Federal Court rulings, official corporate communications, or peer-reviewed academic sources. Reddit / YouTube / LinkedIn URLs deliberately excluded per the source-quality stance documented in the council review.*
