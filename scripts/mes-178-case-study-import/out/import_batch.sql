...
- The Australian entry has been studied academically (QUT) as a successful format transplant', 5),
      ('lessons-for-market-entrants', '<p>Costco proves a genuinely novel retail format can be exported to Australia without dilution — provided the entrant accepts a slow, capital-heavy rollout and lets unit economics, not store count, define success.</p>', 'Costco proves a genuinely novel retail format can be exported to Australia without dilution — provided the entrant accepts a slow, capital-heavy rollout and lets unit economics, not store count, define success.', 6)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
- Targeting a top-three overall sales position in Australia in 2026', 5),
      ('lessons-for-market-entrants', '<p>BYD''s entry is the textbook case for the distributor-first model: use a local partner to buy speed and trust, structure the deal so you can take direct control later, and let product value do the brand-building.</p>', 'BYD''s entry is the textbook case for the distributor-first model: use a local partner to buy speed and trust, structure the deal so you can take direct control later, and let product value do the brand-building.', 6)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
sec_bodies AS (
  ...
  FROM secs s
  JOIN (VALUES
      ('background', '<p>Purplebricks'' UK model — salaried "local property experts," a flat fee paid regardless of sale outcome, and heavy TV advertising — had made it a stock-market darling, with the parent peaking at a £1.3 billion valuation. Australia, with commissions around 2–2.5%, looked like an obvious next market.</p>', 'Purplebricks'' UK model — salaried "local property experts," a flat fee paid regardless of sale outcome, and heavy TV advertising — had made it a stock-market darling, with the parent peaking at a £1.3 billion valuation. Australia, with commissions around 2–2.5%, looked like an obvious next market.', 1),
      ('entry-strategy', '<p>Purplebricks launched nationally with saturation advertising attacking agent commissions. But the model transplanted poorly: the pay-anyway flat fee clashed with Australia''s no-sale-no-fee culture, and its salaried-agent structure collided with a commission-driven local industry — while its low fee couldn''t fund the vendor-paid marketing campaigns (portals, photography, auctions) that Australian sellers expect.</p>', 'Purplebricks launched nationally with saturation advertising attacking agent commissions. But the model transplanted poorly: the pay-anyway flat fee clashed with Australia''s no-sale-no-fee culture, and its salaried-agent structure collided with a commission-driven local industry — while its low fee couldn''t fund the vendor-paid marketing campaigns (portals, photography, auctions) that Australian sellers expect.', 2),
      ('people-and-unravelling', '<ul>
...
- UK parent later sold for a nominal £1 after its £1.3 billion peak', 5),
      ('lessons-for-market-entrants', '<p>Pricing models are cultural, not just mathematical. Purplebricks exported a fee structure that violated local norms and had no economic headroom to adapt — disruptors must validate willingness-to-pay mechanics, not just the headline saving.</p>', 'Pricing models are cultural, not just mathematical. Purplebricks exported a fee structure that violated local norms and had no economic headroom to adapt — disruptors must validate willingness-to-pay mechanics, not just the headline saving.', 6)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('License to the incumbent, don''t fight it', 'license-to-the-incumbent-don-t-fight-it', 3),
      ('Anchor infrastructure in the two biggest cities', 'anchor-infrastructure-in-the-two-biggest-cities', 4),
      ('Exclusivity as the entry wedge, optionality as the endgame', 'exclusivity-as-the-entry-wedge-optionality-as-the-endgame', 5),
      ('People & footprint', 'people-and-footprint', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
),
sec_bodies AS (
...
Australia''s \$100B+ grocery market was a duopoly (Woolworths and Coles) with historically low online penetration. Coles was losing ground to Woolworths in ecommerce and needed a step-change, not an incremental fix.', 1),
      ('entry-strategy', '', '', 2),
      ('license-to-the-incumbent-don-t-fight-it', '<p>Ocado entered by making the local number two its exclusive customer. Under the March 2019 agreement, Ocado partnered with Coles (ASX: COL) to deliver an end-to-end online grocery solution — webshop, robotic single-pick fulfilment, and last-mile delivery software — before the end of FY2023.</p>', 'Ocado entered by making the local number two its exclusive customer. Under the March 2019 agreement, Ocado partnered with Coles (ASX: COL) to deliver an end-to-end online grocery solution — webshop, robotic single-pick fulfilment, and last-mile delivery software — before the end of FY2023.', 3),
      ('anchor-infrastructure-in-the-two-biggest-cities', '<p>The deal committed both parties to two robotic CFCs, one in Sydney and one in Melbourne, serving Australia''s largest urban catchments, while customers in less populated areas were served through Ocado''s store-pick software — a pragmatic hybrid for Australia''s dispersed geography.</p>', 'The deal committed both parties to two robotic CFCs, one in Sydney and one in Melbourne, serving Australia''s largest urban catchments, while customers in less populated areas were served through Ocado''s store-pick software — a pragmatic hybrid for Australia''s dispersed geography.', 4),
      ('exclusivity-as-the-entry-wedge-optionality-as-the-endgame', '<p>Exclusivity gave Coles confidence to commit capital and gave Ocado a flagship reference customer. By early 2026, mutual exclusivity had ended in most live markets including Australia — positioning Ocado to sell its automation to other Australian retailers now that the technology is locally proven.</p>', 'Exclusivity gave Coles confidence to commit capital and gave Ocado a flagship reference customer. By early 2026, mutual exclusivity had ended in most live markets including Australia — positioning Ocado to sell its automation to other Australian retailers now that the technology is locally proven.', 5),
      ('people-and-footprint', '<ul>
...
- **One customer is the whole market.** Ocado''s Australian ''customer base'' was a single logo: Coles. Its local headcount and engineering presence exist to serve that account — the defining trait of infrastructure-licensing entries.', 6),
      ('success-factors', '<ul>
...
- **Patience on timelines**: robotic CFCs took years to go live, but the multi-year contract structure absorbed delays without killing the deal.', 7),
      ('key-metrics-and-performance', '<ul>
...
- Late 2025 – early 2026: mutual exclusivity ended, opening the rest of the Australian market to Ocado.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **Structure for long infrastructure timelines.** Multi-year milestones kept the partnership intact through construction delays.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Buy the local leader instead of fighting it', 'buy-the-local-leader-instead-of-fighting-it', 3),
      ('Structure the deal to keep the team', 'structure-the-deal-to-keep-the-team', 4),
      ('Repeat on the other side of the market', 'repeat-on-the-other-side-of-the-market', 5),
      ('People & continuity', 'people-and-continuity', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **The acquired brand kept selling.** The product ran as "Kounta powered by Lightspeed" before fully rebranding, keeping the trusted local name in front of its 7,000+ venues while the base grew past 10,000 venues across Australia and New Zealand.', 6),
      ('success-factors', '<ul>
...
- **Existing integrations as moats acquired**: MYOB, CBA and Xero ecosystem ties came with the deals.', 7),
      ('key-metrics-and-performance', '<ul>
...
- Post-acquisition: 10,000+ venues across AU/NZ on the hospitality product alone; Lightspeed positioned as a top cloud POS provider in APAC.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **A listed acquirer''s shares are an entry weapon.** Part-scrip deals stretched Lightspeed''s capital across multiple markets simultaneously.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Sell the engine, not the bank', 'sell-the-engine-not-the-bank', 3),
      ('Speed as proof of value', 'speed-as-proof-of-value', 4),
      ('Target the segment the majors ignore', 'target-the-segment-the-majors-ignore', 5),
      ('First customer & delivery', 'first-customer-and-delivery', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Early traction.** AMP Bank GO went live with 11,600 pre-release customers, targeting 24,000 personal and 58,000 business customers by the end of 2026.', 6),
      ('success-factors', '<ul>
...
- **Segment focus**: launching for micro business avoided head-on deposit wars with CBA/NAB.', 7),
      ('key-metrics-and-performance', '<ul>
...
- Year one: award-winning launch; partnerships with Xero and Qantas; 50K+ app downloads on Google Play.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **Pick a wedge segment.** Micro businesses were underserved enough to switch and small enough not to provoke an incumbent response.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Soft launch first, market later', 'soft-launch-first-market-later', 3),
      ('Raise specifically for the expansion', 'raise-specifically-for-the-expansion', 4),
      ('Keep the wedge identical', 'keep-the-wedge-identical', 5),
      ('Team & launch playbook', 'team-and-launch-playbook', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Named backers for the expansion raise.** The 2021 Series C (about A\$48 million) was led by US fund Amplo, with DST Global''s Rahul Mehta, Benton Group, Icehouse Ventures and Even Capital participating — announced from Sydney with funds earmarked for the Australian build-out.', 6),
      ('success-factors', '<ul>
...
- **Capital raised with a purpose**: the expansion was funded before it was needed, avoiding mid-entry funding crunches.', 7),
      ('key-metrics-and-performance', '<ul>
...
- Today: 1M+ customers across NZ and Australia; \$12B+ invested; 10,000+ companies and ETFs available across NZ, AU and US markets.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **A beginner-friendly brand travels.** Positioning against category intimidation — not against a specific incumbent — worked identically on both sides of the Tasman.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Distribute through the channel, not to the end customer', 'distribute-through-the-channel-not-to-the-end-customer', 3),
      ('Partner with the airline that owns the market', 'partner-with-the-airline-that-owns-the-market', 4),
      ('Use capital markets as an entry tool', 'use-capital-markets-as-an-entry-tool', 5),
      ('People & anchor customers', 'people-and-anchor-customers', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Qantas as the technology partner.** The NDC partnership gave Zeno first-mover access to Qantas direct content and pricing — with the airline that owns Australian corporate travel share.', 6),
      ('success-factors', '<ul>
...
- **Trans-Tasman adjacency**: shared language, carriers and TMCs made Australia a low-friction first international market — the classic NZ scale-up path.', 7),
      ('key-metrics-and-performance', '<ul>
...
- FY23 revenue NZ\$48M, with FY24 guidance of NZ\$63–70M; 6,000+ corporate customers across 35+ countries.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **Treat adjacency as a launchpad, not a destination.** Australian dominance funded and de-risked the later push into North America and Europe.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Phase 1: challenger retail brand (2019–2021)', 'phase-1-challenger-retail-brand-2019-2021', 3),
      ('Phase 2: partner with the incumbent instead (2021)', 'phase-2-partner-with-the-incumbent-instead-2021', 4),
      ('Phase 3: the technology becomes the business (2023–2024)', 'phase-3-the-technology-becomes-the-business-2023-2024', 5),
      ('Team & local footprint', 'team-and-local-footprint', 6),
      ('Success and failure factors', 'success-and-failure-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
...
- **Customers as the proof point.** The roughly 80,000-customer base that team built became the live migration sandbox that ultimately sold Kaluza to AGL.', 6),
      ('success-and-failure-factors', '<ul>
...
- **Solar-rich grid fit**: Australia''s rooftop solar and EV growth made Kaluza''s flexibility software strategically valuable beyond billing.', 7),
      ('key-metrics-and-performance', '<ul>
...
- June 2024: AGL invests \~A\$150M for 20% of Kaluza; \~4M customer services to migrate by \~2028; US\$46–60M annual pre-tax savings targeted.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **Sequence brand → proof → platform.** Each phase created the credibility the next one needed.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Let the product cross the border first', 'let-the-product-cross-the-border-first', 3),
      ('Localise the money, not just the language', 'localise-the-money-not-just-the-language', 4),
      ('Grow an ecosystem that sells for you', 'grow-an-ecosystem-that-sells-for-you', 5),
      ('Team & flagship merchants', 'team-and-flagship-merchants', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Lean headcount, partner leverage.** Even at global scale (about 7,600 employees in 2025), Shopify''s Australian model stayed partner-heavy: agencies and app developers in Sydney and Melbourne did much of the selling.', 6),
      ('success-factors', '<ul>
...
- **Merchant success flywheel**: visible local DTC winners recruited the next generation of founders to the platform by default.', 7),
      ('key-metrics-and-performance', '<ul>
...
- Australia consistently cited as one of Shopify''s most "Shopify-native" markets, with a mature agency ecosystem in Sydney and Melbourne.', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **Your customers'' success stories are your market entry campaign.** Local hero brands did more for Shopify''s Australian credibility than advertising could.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Ride on incumbent infrastructure', 'ride-on-incumbent-infrastructure', 3),
      ('Buy attention with an outrageous offer', 'buy-attention-with-an-outrageous-offer', 4),
      ('Stage the geographic rollout', 'stage-the-geographic-rollout', 5),
      ('Digital-only distribution', 'digital-only-distribution', 6),
      ('Team & endgame', 'team-and-endgame', 7),
...
- **The exit closed the loop.** In January 2025 the Australian customer base was acquired by amaysim — the Optus-network rival Retzlaff had come from — with customers transferred to the same underlying network for a seamless migration.', 7),
      ('success-factors', '<ul>
...
- Knew its endgame: when scale economics favoured consolidation, it sold the base to Amaysim and reframed the exit as proof of its build-operate-transfer model for telco software', 8),
      ('key-metrics-and-performance', '<ul>
...
- Customer base transferred to Amaysim, completing the entry-to-exit arc', 9),
      ('lessons-for-market-entrants', '<ol>
...
4. **Exit can be strategy.** A well-executed transfer of the customer base converted a sub-scale retail position into a credential for the company''s software business.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ...
      ('Paid a knockout premium for speed', 'paid-a-knockout-premium-for-speed', 3),
      ('Bought a deal to dress an IPO', 'bought-a-deal-to-dress-an-ipo', 4),
      ('Left management in place, hands-off from Tokyo', 'left-management-in-place-hands-off-from-tokyo', 5),
      ('Deal mechanics & aftermath', 'deal-mechanics-and-aftermath', 6),
      ('Failure factors', 'failure-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
...
- **The unwinding.** After the April 2017 write-down (about US\$3.6 billion), Japan Post progressively shrank Toll, selling major divisions including its US warehousing and trucking operations.', 6),
      ('failure-factors', '<ul>
...
- Deal logic anchored to Japan Post''s IPO narrative rather than logistics fundamentals', 7),
      ('key-metrics-and-performance', '<ul>
...
- Toll was subsequently restructured, with major divestments in later years', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **Scale in a market is not capability in a market.** Owning Australia''s biggest logistics firm did not make Japan Post a capable logistics operator in Australia.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Buy the established challenger, don''t build', 'buy-the-established-challenger-don-t-build', 3),
      ('Keep the local brand', 'keep-the-local-brand', 4),
      ('List locally', 'list-locally', 5),
      ('Ignore the sceptics', 'ignore-the-sceptics', 6),
      ('Deal mechanics & people', 'deal-mechanics-and-people', 7),
      ('Success factors', 'success-factors', 8),
      ('Key metrics & performance', 'key-metrics-and-performance', 9),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 10)
  ) AS v(title, slug, ord)
...
- **All the way to 100%.** Rather than settling for control, Singtel completed compulsory acquisition of every outstanding share by 23 October 2001, taking full ownership and avoiding a minority-shareholder overhang.', 7),
      ('success-factors', '<ul>
...
- Patient ownership through market cycles rather than a quick flip', 8),
      ('key-metrics-and-performance', '<ul>
...
- Optus remains Australia''s second-largest telco today', 9),
      ('lessons-for-market-entrants', '<ol>
...
4. **Local capital-market presence builds legitimacy** with institutions, regulators and talent.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Buy distress, not trophies', 'buy-distress-not-trophies', 3),
      ('Persist through board opposition', 'persist-through-board-opposition', 4),
      ('Keep the local brand and let it run', 'keep-the-local-brand-and-let-it-run', 5),
      ('Use the platform as a beachhead for the brand ladder', 'use-the-platform-as-a-beachhead-for-the-brand-ladder', 6),
      ('People & platform', 'people-and-platform', 7),
      ('Success factors', 'success-factors', 8),
      ('Key metrics & performance', 'key-metrics-and-performance', 9),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 10)
  ) AS v(title, slug, ord)
...
- Long-horizon ownership building from mid-market to luxury', 8),
      ('key-metrics-and-performance', '<ul>
...
- Anantara Perth announced for the A\$3.8B Burswood Point precinct, opening 2032', 9),
      ('lessons-for-market-entrants', '<ol>
...
4. **Mid-market platforms can carry luxury ambitions** into a new market decades later.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ...
      ('The 7-year warranty as a trust shortcut', 'the-7-year-warranty-as-a-trust-shortcut', 3),
      ('Local ride and handling tuning', 'local-ride-and-handling-tuning', 4),
      ('Market-specific product', 'market-specific-product', 5),
      ('Mainstream visibility through sport', 'mainstream-visibility-through-sport', 6),
      ('Success factors', 'success-factors', 7),
      ('Key metrics & performance', 'key-metrics-and-performance', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- Warranty leadership reframed the value conversation away from price alone', 7),
      ('key-metrics-and-performance', '<ul>
...
- Headwinds emerging: Australian earnings fell 37% in 2025 amid intense competition from Chinese brands, and the Tasman''s launch campaign underperformed expectations', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. **No position is permanent.** The value territory Kia conquered is exactly where Chinese entrants are now attacking.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Transplant the fixed-price format', 'transplant-the-fixed-price-format', 3),
      ('Treasure-hunt merchandising', 'treasure-hunt-merchandising', 4),
      ('Quality-for-price positioning', 'quality-for-price-positioning', 5),
      ('Shopping-centre clustering', 'shopping-centre-clustering', 6),
      ('Local structure & footprint', 'local-structure-and-footprint', 7),
      ('Success factors', 'success-factors', 8),
      ('Key metrics & performance', 'key-metrics-and-performance', 9),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 10)
  ) AS v(title, slug, ord)
...
- **The second brand has landed.** Daiso''s design-led sister chain Standard Products opened in Sydney and then Melbourne''s Midtown Plaza (November 2025), including dual-brand stores — a second format riding the infrastructure the first one built.', 7),
      ('success-factors', '<ul>
...
- Measured expansion paced to demand — including later rationalisation of the network', 8),
      ('key-metrics-and-performance', '<ul>
...
- Globally: 5,500+ stores across 25 countries and regions', 9),
      ('lessons-for-market-entrants', '<ol>
...
4. **Right-sizing is not retreat.** Trimming the network after rapid growth kept the business sustainable.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Expand before competitors exist', 'expand-before-competitors-exist', 3),
      ('Replicate a data-driven playbook', 'replicate-a-data-driven-playbook', 4),
      ('Outspend to defend', 'outspend-to-defend', 5),
      ('Deepen monetisation once entrenched', 'deepen-monetisation-once-entrenched', 6),
      ('Team & local build-out', 'team-and-local-build-out', 7),
...
- **Local M&A to deepen the moat.** In 2021 HelloFresh agreed to acquire Brisbane-based ready-meal maker Youfoodz for A\$125 million (about US\$93 million) — buying Australian manufacturing capability, a known local brand and a second product line (prepared meals) to serve more meal occasions.', 7),
      ('why-it-worked', '<ul>
...
- **Operational rigour** — the only meal-kit player to reach profitability at scale globally.', 8),
      ('key-metrics', '<ul>
...
- Consistently ranked one of the two dominant meal-kit brands in Australian category reviews', 9),
      ('lessons', '<ol>
...
4. Win the land-grab first; monetise the base second.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Launch with supply already on the shelf', 'launch-with-supply-already-on-the-shelf', 3),
      ('Buy trial with aggressive launch promotions', 'buy-trial-with-aggressive-launch-promotions', 4),
      ('Commit locally, not remotely', 'commit-locally-not-remotely', 5),
      ('Outlast the shakeout', 'outlast-the-shakeout', 6),
      ('Team & scale-up', 'team-and-scale-up', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons', 'lessons', 10)
  ) AS v(title, slug, ord)
...
- **Local leaders got exported.** Burrows relocated to San Francisco in 2022 to run DoorDash''s international operations across Canada, Australia and New Zealand — succeeded locally by Melbourne-based GM Puji Fernando (2022–2024). Australia became a leadership farm, not just a market.', 7),
      ('why-it-worked', '<ul>
...
- **Late-mover discipline** — let better-funded rivals exhaust themselves, then consolidated share as they exited.', 8),
      ('key-metrics', '<ul>
...
- One of only two major platforms still standing as Menulog wound down', 9),
      ('lessons', '<ol>
...
4. In shakeout markets, survival is a strategy: the last well-capitalised challenger inherits the exiters'' share.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Test in a small market first', 'test-in-a-small-market-first', 3),
      ('Pick the second city, not the first', 'pick-the-second-city-not-the-first', 4),
      ('Compete on price in a commodity market', 'compete-on-price-in-a-commodity-market', 5),
      ('Expand methodically', 'expand-methodically', 6),
      ('Rollout & local team', 'rollout-and-local-team', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons', 'lessons', 10)
  ) AS v(title, slug, ord)
...
- **Two million riders** had used DiDi in Australia by the time Sydney launched.', 7),
      ('why-it-worked', '<ul>
...
- **Multi-homing dynamics** — drivers and riders happily added a second app, so incumbency was rentable, not owned.', 8),
      ('key-metrics', '<ul>
...
- Among the last challengers standing: Ola and Bolt both exited, DiDi remains in AU and NZ', 9),
      ('lessons', '<ol>
...
4. Challenger shakeouts reward the deepest balance sheet, not the earliest arrival.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ...
      ('Challenger economics with no buffer', 'challenger-economics-with-no-buffer', 3),
      ('A four-way war for the same riders', 'a-four-way-war-for-the-same-riders', 4),
      ('COVID as the margin call', 'covid-as-the-margin-call', 5),
      ('Footprint & the second act', 'footprint-and-the-second-act', 6),
      ('Why it failed', 'why-it-failed', 7),
      ('Key metrics', 'key-metrics', 8),
      ('Lessons', 'lessons', 9)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
),
...
- **The region wasn''t abandoned forever.** Bolt later re-entered Australasia via Auckland, launching against Uber and DiDi with a dedicated New Zealand country manager — while Australia remains absent from its 850+-city global map, a measure of how thoroughly the 2020 exit closed the door.', 6),
      ('why-it-failed', '<ul>
...
- **Global triage** — Australia was a marginal experiment for a company whose strongholds were Europe and Africa; when capital tightened, it was cut first.', 7),
      ('key-metrics', '<ul>
...
- 0 days'' operational wind-down — termination effective at midnight', 8),
      ('lessons', '<ol>
...
4. Exit manner matters: overnight terminations become the story competitors tell about you in every future market.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Break the drought with data', 'break-the-drought-with-data', 3),
      ('Assemble a capability portfolio, deal by deal', 'assemble-a-capability-portfolio-deal-by-deal', 4),
      ('Consolidate into a flagship bet', 'consolidate-into-a-flagship-bet', 5),
      ('People & deal craft', 'people-and-deal-craft', 6),
      ('Why it worked', 'why-it-worked', 7),
      ('Key metrics', 'key-metrics', 8),
      ('Lessons', 'lessons', 9)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
...
- **Portfolio logic** — five complementary deals compounded into a credible transformation story no single acquisition could tell.', 7),
      ('key-metrics', '<ul>
...
- \~\$8B addressable Australian cyber consulting market', 8),
      ('lessons', '<ol>
...
4. A sequence of small, thematic deals de-risks transformation better than one transformational bet.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Borrow a loyalty program', 'borrow-a-loyalty-program', 3),
      ('Win the supply side with service', 'win-the-supply-side-with-service', 4),
      ('Put leadership in the region', 'put-leadership-in-the-region', 5),
      ('Leverage the Asia corridor', 'leverage-the-asia-corridor', 6),
      ('Local footprint', 'local-footprint', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons', 'lessons', 10)
  ) AS v(title, slug, ord)
...
- **Founder continuity.** Agoda was founded in Thailand in 2005 by two lifelong friends; co-founder Robert Rosenstein led it as president and CEO for more than a decade (now chairman), preserving the Asia-first identity that gives the Australian offer its corridor advantage.', 7),
      ('why-it-worked', '<ul>
...
- **A defensible wedge** — Asia-corridor strength that global rivals couldn''t easily match.', 8),
      ('key-metrics', '<ul>
...
- First market worldwide to receive Agoda''s 24/7 partner support', 9),
      ('lessons', '<ol>
...
4. Lead with the corridor you dominate; adjacency will carry you into the domestic market.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Partner with the local champion', 'partner-with-the-local-champion', 3),
      ('Introduce subscription once the base existed', 'introduce-subscription-once-the-base-existed', 4),
      ('Widen the offer', 'widen-the-offer', 5),
      ('Add physical retail reach', 'add-physical-retail-reach', 6),
      ('Partners & people', 'partners-and-people', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons', 'lessons', 10)
  ) AS v(title, slug, ord)
...
- **Bookseller channel consolidated.** Distribution runs through Booktopia and its subsidiary Angus & Robertson — Kobo''s only Australian retail partners — replacing an earlier local arrangement, with announcements issued from Sydney.', 7),
      ('why-it-worked', '<ul>
...
- **Subscription economics** — Kobo Plus locked in readers Amazon would otherwise own by default.', 8),
      ('key-metrics', '<ul>
...
- Audiobooks added 17 August 2023 (A\$13.99–A\$16.99/month); Officeworks retail from June 2026', 9),
      ('lessons', '<ol>
...
4. Subscription pricing localised to market norms converts casual buyers into locked-in ecosystems.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Start small, stay permanent', 'start-small-stay-permanent', 3),
      ('Grow with national infrastructure', 'grow-with-national-infrastructure', 4),
      ('Become a government-grade incumbent', 'become-a-government-grade-incumbent', 5),
      ('Compound trust as the moat', 'compound-trust-as-the-moat', 6),
      ('Footprint & flagship contracts', 'footprint-and-flagship-contracts', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons', 'lessons', 10)
  ) AS v(title, slug, ord)
...
sec_bodies AS (
  ...
  FROM secs s
  JOIN (VALUES
      ('background', '<p>In the late 1960s NEC began building an international subsidiary network, establishing NEC Australia in 1969 — among its early overseas outposts alongside Mexico and Brazil. Australia''s expanding telecommunications infrastructure and government procurement market made it a logical, if unglamorous, long-term bet.</p>', 'In the late 1960s NEC began building an international subsidiary network, establishing NEC Australia in 1969 — among its early overseas outposts alongside Mexico and Brazil. Australia''s expanding telecommunications infrastructure and government procurement market made it a logical, if unglamorous, long-term bet.', 1),
      ('entry-strategy', '', '', 2),
      ('start-small-stay-permanent', '<p>NEC Australia opened with just five staff. The entry wasn''t a splash but a stake in the ground: a wholly owned subsidiary structured for decades of patient growth rather than a distributor arrangement that could be unwound.</p>', 'NEC Australia opened with just five staff. The entry wasn''t a splash but a stake in the ground: a wholly owned subsidiary structured for decades of patient growth rather than a distributor arrangement that could be unwound.', 3),
      ('grow-with-national-infrastructure', '<p>NEC built its Australian business by supplying the technology underneath the country''s communications build-out — telecommunications equipment first, then ICT systems and services as the market evolved. By 2001 the subsidiary employed more than 1,400 people.</p>', 'NEC built its Australian business by supplying the technology underneath the country''s communications build-out — telecommunications equipment first, then ICT systems and services as the market evolved. By 2001 the subsidiary employed more than 1,400 people.', 4),
      ('become-a-government-grade-incumbent', '<p>Over decades, NEC embedded itself in government and enterprise contracts — the slowest customers to win and the slowest to leave — later extending into specialised strengths like biometrics and identity systems.</p>', 'Over decades, NEC embedded itself in government and enterprise contracts — the slowest customers to win and the slowest to leave — later extending into specialised strengths like biometrics and identity systems.', 5),
      ('compound-trust-as-the-moat', '<p>Fifty-five years of continuous local operation, local employment and delivery history became NEC''s core differentiator against newer entrants: in public-sector technology, longevity itself is a credential.</p>', 'Fifty-five years of continuous local operation, local employment and delivery history became NEC''s core differentiator against newer entrants: in public-sector technology, longevity itself is a credential.', 6),
      ('footprint-and-flagship-contracts', '<ul>
...
- **The cautionary counterweight.** That biometrics flagship also shows incumbency''s limits: the ACIC terminated the Biometric Identification Services project (worth up to A\$52 million) in June 2018 over delays, and NEC took the agency to court — proof that even a 50-year government incumbent can lose a marquee project.', 7),
      ('why-it-worked', '<ul>
...
- **Evolution without exit** — the business repeatedly shifted portfolio (telecoms → ICT → biometrics) without ever leaving.', 8),
      ('key-metrics', '<ul>
...
- One of the first Japanese technology subsidiaries in the country', 9),
      ('lessons', '<ol>
...
4. Long-lived entrants survive by migrating their portfolio, not their postcode.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Launch into the tailwind', 'launch-into-the-tailwind', 3),
      ('Hire a regional builder, not a country manager', 'hire-a-regional-builder-not-a-country-manager', 4),
      ('Land marquee local logos', 'land-marquee-local-logos', 5),
      ('Make the HQ a statement', 'make-the-hq-a-statement', 6),
      ('Win the brand war', 'win-the-brand-war', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 10)
  ) AS v(title, slug, ord)
...
- **Visible commitment.** A 1,000+ sqm CBD headquarters and marquee logos converted momentum into enterprise trust.', 8),
      ('key-metrics', '<ul>
...
- Brand rank in category: **#6 to #1**; largest land deal in company history: **\$2.2M TCV**; AFR Best Place to Work 2025', 9),
      ('lessons-for-market-entrants', '<ol>
...
4. Sequence: remote launch to capture demand, then a statement HQ to convert enterprise trust. Physical presence can follow traction.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('A regional HQ, not a sales outpost', 'a-regional-hq-not-a-sales-outpost', 3),
      ('Product development from day one', 'product-development-from-day-one', 4),
      ('Partnering with the Victorian Government', 'partnering-with-the-victorian-government', 5),
      ('Build a senior local bench early', 'build-a-senior-local-bench-early', 6),
      ('Winning internal investment', 'winning-internal-investment', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 10)
  ) AS v(title, slug, ord)
...
- **Riding organic demand.** Australian businesses were already adopting Zendesk; the local presence converted grassroots adoption into enterprise relationships.', 8),
      ('key-metrics', '<ul>
...
- 2024: Zendesk Pty Ltd generates **A\$133M** in local revenue with **346 employees**', 9),
      ('lessons-for-market-entrants', '<ol>
...
4. Start small and compound. Five people in 2011 became a global product hub by 2018 because each phase earned the next.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Start lean: seven people, one serviced office', 'start-lean-seven-people-one-serviced-office', 3),
      ('A regional remit from day one', 'a-regional-remit-from-day-one', 4),
      ('Partner-agency channel as the GTM engine', 'partner-agency-channel-as-the-gtm-engine', 5),
      ('Sell the methodology, not just the software', 'sell-the-methodology-not-just-the-software', 6),
      ('Why it worked', 'why-it-worked', 7),
      ('Key metrics', 'key-metrics', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Regional mandate.** Covering ANZ, Japan and Singapore from Sydney gave the office scale economics a single-country office wouldn''t have had.', 7),
      ('key-metrics', '<ul>
...
- Remit: Australia, New Zealand, Japan and Singapore', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. Scope the first office regionally. Sydney-as-APAC-anchor created a far stronger business case than Sydney-as-Australia-office.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Hire people, not offices', 'hire-people-not-offices', 3),
      ('Open the office only when the data demands it', 'open-the-office-only-when-the-data-demands-it', 4),
      ('Localise the product for regulated buyers', 'localise-the-product-for-regulated-buyers', 5),
      ('Keep compounding', 'keep-compounding', 6),
      ('Why it worked', 'why-it-worked', 7),
      ('Key metrics', 'key-metrics', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Localisation unlocked the enterprise.** Australian data hosting turned compliance objections into wins — with Atlassian as the proof point.', 7),
      ('key-metrics', '<ul>
...
- March 2026: **\$250M debt raise**; 650 new hires planned globally across six offices, including Sydney', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. Data residency is a genuine GTM unlock in Australia — compliance features open segments marketing can''t reach.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('What went wrong', 'what-went-wrong', 2),
      ('The cloud broke the partnership', 'the-cloud-broke-the-partnership', 3),
      ('Re-entering your own market', 're-entering-your-own-market', 4),
      ('Xero had already won the shift', 'xero-had-already-won-the-shift', 5),
      ('Why it failed', 'why-it-failed', 6),
      ('Key metrics', 'key-metrics', 7),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 8)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
),
sec_bodies AS (
...
- **Brand confusion.** Decades of "QuickBooks = Reckon''s desktop product" muddied Intuit''s cloud relaunch.', 6),
      ('key-metrics', '<ul>
...
- Today: Xero holds **60%+ advisor share** in Australia; QuickBooks a distant third (**\~8%** click share)', 7),
      ('lessons-for-market-entrants', '<ol>
...
4. Re-entry is harder than entry: you carry brand baggage, face an entrenched winner, and start behind challengers you once outranked.', 8)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('An APAC HQ with product localisation', 'an-apac-hq-with-product-localisation', 3),
      ('Team and investment upfront', 'team-and-investment-upfront', 4),
      ('Global platform vs local specialist', 'global-platform-vs-local-specialist', 5),
      ('Entering hostile territory', 'entering-hostile-territory', 6),
      ('Why it''s contested', 'why-it-s-contested', 7),
      ('Key metrics', 'key-metrics', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
  RETURNING id, content_id, slug
...
- **But the platform pitch is real.** For multinationals and consolidators, Rippling''s unified system is a differentiated wedge no local player fully matches.', 7),
      ('key-metrics', '<ul>
...
- Outcome: ongoing — scaling fast, but the incumbent remains entrenched', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. Scope the first office as a regional HQ — it attracts stronger leadership hires and justifies bigger launch investment.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('Skip the obvious cities', 'skip-the-obvious-cities', 3),
      ('Grow where you''re wanted', 'grow-where-you-re-wanted', 4),
      ('Add coverage, keep the anchor', 'add-coverage-keep-the-anchor', 5),
      ('Value pricing for the SME long tail', 'value-pricing-for-the-sme-long-tail', 6),
      ('Why it worked', 'why-it-worked', 7),
      ('Key metrics', 'key-metrics', 8),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 9)
  ) AS v(title, slug, ord)
...
- **Underserved segment focus.** SME-first pricing avoided head-on collision with enterprise incumbents.', 7),
      ('key-metrics', '<ul>
...
- March 2026: second office opens in Parramatta, Western Sydney', 8),
      ('lessons-for-market-entrants', '<ol>
...
4. Serving the SME long tail is a viable wedge in a market where incumbents chase enterprise logos.', 9)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
...
secs AS (
  ...
  FROM item, (VALUES
      ('Background', 'background', 1),
      ('Entry strategy', 'entry-strategy', 2),
      ('A beachhead in Sydney', 'a-beachhead-in-sydney', 3),
      ('Challenger economics as the GTM', 'challenger-economics-as-the-gtm', 4),
      ('Expand on milestones, not ambition', 'expand-on-milestones-not-ambition', 5),
      ('Localise the infrastructure', 'localise-the-infrastructure', 6),
      ('Anchor the brand in local culture', 'anchor-the-brand-in-local-culture', 7),
      ('Why it worked', 'why-it-worked', 8),
      ('Key metrics', 'key-metrics', 9),
      ('Lessons for market entrants', 'lessons-for-market-entrants', 10)
  ) AS v(title, slug, ord)
...
- **Local presence where it counts.** Sydney and Melbourne cover the large majority of Australian enterprise and mid-market buyers.', 8),
      ('key-metrics', '<ul>
...
- Later: NRL rolls out Freshservice across **all 17 clubs and 1,200 staff**; May 2024: Andrew Phillips (ex-AWS) appointed ANZ country manager & VP', 9),
      ('lessons-for-market-entrants', '<ol>
...
3. In Australia, a two-city presence (Sydney + Melbourne) is the practical definition of "national coverage" for B2B SaaS.', 10)
  ) AS v(slug, html, md, ord) ON v.slug = s.slug
)
INSERT INTO public.content_company_profiles
  (content_id, company_name, origin_country, target_market, industry, entry_date, outcome)
